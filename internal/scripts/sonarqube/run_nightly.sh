...
#    METdataio/sonarqube/run_nightly.sh name
#
...
# Constants
EMAIL_LIST="johnhg@ucar.edu hsoh@ucar.edu jpreso@ucar.edu minnawin@ucar.edu"
KEEP_DAYS=5
GIT_REPO_NAME=METdataio
...
SONARQUBE_WORK_DIR=${MET_PROJ_DIR}/MET_regression/sonarqube_${GIT_REPO_NAME}
